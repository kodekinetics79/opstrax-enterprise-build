  ...
  if (mfaChallenge) {
    return (
      <View style={styles.loginInner}>
        ...
        <Pressable accessibilityRole="button" accessibilityLabel="Verify code" onPress={() => void submitMfa()} disabled={busy || !/^\d{6}$/.test(mfaCode)} style={({ pressed }) => [styles.signButton, pressed && { opacity: 0.9 }]}>
