...
const styles = StyleSheet.create({
  ...
  fieldValue: { color: colors.text, fontSize: 14, lineHeight: 20, fontWeight: "650" },
  ...
  quickActionTitle: { color: colors.text, fontSize: 14, fontWeight: "850" },
  ...
  loadingLabel: { color: colors.muted, fontSize: 13, fontWeight: "650" },
