...
const tenantDetail = readFileSync(new URL("../src/pages/platform/tenant-management/TenantDetailDrawer.tsx", import.meta.url), "utf8");
...
assert.match(tenantDetail, /"tenant admin", "company admin"/);
assert.match(tenantDetail, /roleName: "Tenant Admin"/);
