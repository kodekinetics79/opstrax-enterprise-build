...
export const modules: ModuleConfig[] = [
  ...
  { key: "cold-chain",     title: "Cold Chain",     route: "/cold-chain",     group: "Telematics & IoT", description: "Temperature, set point, humidity, door status and breach compliance.", accent: "blue",   requiredPermission: "telematics:sensors:view", requiredEntitlement: "telematics" },
