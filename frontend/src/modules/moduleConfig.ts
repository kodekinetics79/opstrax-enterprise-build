...
export const modules: ModuleConfig[] = [
  ...
  { key: "quotations",      title: "Quotations",        route: "/quotations",      group: "Commercial", description: "Quote lifecycle from draft to sent, accepted and converted booking.", accent: "amber",  requiredPermission: "crm.view", requiredEntitlement: "crm" },
