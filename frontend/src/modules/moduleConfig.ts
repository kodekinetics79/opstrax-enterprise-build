...
export const modules: ModuleConfig[] = [
  ...
  { key: "fleet-live-wall",  title: "Fleet Live Wall",      route: "/fleet/live-wall",   group: "Operations", description: "Every vehicle's live telemetry as a wall of panels; open any vehicle on its own screen/monitor.", accent: "blue",   requiredPermission: "telemetry.live_state.read" },
  ...
  { key: "jobs",               title: "Jobs",               route: "/jobs",               group: "Transport Operations", description: "Job register — delivery, collection, transfer, and job status with driver and vehicle linkage.", accent: "teal",   requiredPermission: "shipments:view" },
