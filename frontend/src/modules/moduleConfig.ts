...
export const modules: ModuleConfig[] = [
  ...
  { key: "dashcam",        title: "Dashcam Events", route: "/dashcam",        group: "Telematics & IoT", description: "Dashcam events, review workflow, clips and evidence creation.", accent: "purple", requiredPermission: "dashcam.view", requiredEntitlement: "safety" },
