...
export const modules: ModuleConfig[] = [
  ...
  { key: "integrations",    title: "Integrations",   route: "/integrations",    group: "Governance", description: "ERP, WMS, accounting, telematics, fuel card, messaging and payment integrations.", accent: "teal",   requiredPermission: "telematics:providers:manage" },
