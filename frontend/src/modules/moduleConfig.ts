...
export const modules: ModuleConfig[] = [
  ...
  { key: "dashcam",        title: "Camera Metadata", route: "/dashcam",        group: "Safety & Compliance", description: "Stored, unverified camera event metadata. Media, provider connectivity and automated assessments are unavailable.", accent: "purple", requiredPermission: "dashcam.view", requiredEntitlement: "safety" },
