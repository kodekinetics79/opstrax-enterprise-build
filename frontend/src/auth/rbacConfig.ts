export const PERMISSIONS = {
  ...
  OPERATIONS_EXECUTION_SUMMARY_READ: "operations.execution_summary.read",
  DISPATCH_SMART_ASSIGN_READ: "dispatch.smart_assign.read",
  DISPATCH_SMART_ASSIGN_RECOMMEND: "dispatch.smart_assign.recommend",
  DISPATCH_SMART_ASSIGN_ACCEPT: "dispatch.smart_assign.accept",
  DISPATCH_SMART_ASSIGN_REJECT: "dispatch.smart_assign.reject",
  OPERATIONS_SITE_ACCESS_READ: "operations.site_access.read",
  OPERATIONS_SITE_ACCESS_CREATE: "operations.site_access.create",
  OPERATIONS_SITE_ACCESS_UPDATE: "operations.site_access.update",
  OPERATIONS_ACCESS_DOCUMENT_READ: "operations.access_document.read",
  OPERATIONS_ACCESS_DOCUMENT_CREATE: "operations.access_document.create",
  OPERATIONS_ACCESS_DOCUMENT_UPDATE: "operations.access_document.update",
  OPERATIONS_ACCESS_DOCUMENT_VERIFY: "operations.access_document.verify",
  OPERATIONS_PICKUP_AUTHORIZATION_READ: "operations.pickup_authorization.read",
  OPERATIONS_PICKUP_AUTHORIZATION_CREATE: "operations.pickup_authorization.create",
  OPERATIONS_PICKUP_AUTHORIZATION_UPDATE: "operations.pickup_authorization.update",
  OPERATIONS_PICKUP_AUTHORIZATION_VERIFY: "operations.pickup_authorization.verify",
  OPERATIONS_WAREHOUSE_HANDOVER_READ: "operations.warehouse_handover.read",
  OPERATIONS_WAREHOUSE_HANDOVER_CREATE: "operations.warehouse_handover.create",
  OPERATIONS_WAREHOUSE_HANDOVER_UPDATE: "operations.warehouse_handover.update",
  OPERATIONS_PROOF_READ: "operations.proof.read",
  OPERATIONS_PROOF_CREATE: "operations.proof.create",
  OPERATIONS_PROOF_UPDATE: "operations.proof.update",
  OPERATIONS_PROOF_SUBMIT: "operations.proof.submit",
  OPERATIONS_PROOF_VALIDATE: "operations.proof.validate",
  OPERATIONS_PROOF_ARTIFACT_READ: "operations.proof_artifact.read",
  ...
  TELEMETRY_LIVE_STATE_READ: "telemetry.live_state.read",
  TELEMETRY_DEVICES_READ: "telemetry.devices.read",
  TELEMETRY_DEVICES_MANAGE: "telemetry.devices.manage",
  TELEMETRY_ALERTS_READ: "telemetry.alerts.read",
  TELEMETRY_ALERTS_MANAGE: "telemetry.alerts.manage",
  TELEMETRY_RULES_READ: "telemetry.rules.read",
  TELEMETRY_RULES_MANAGE: "telemetry.rules.manage",
  TELEMETRY_RECOMMENDATIONS_READ: "telemetry.recommendations.read",
...
const PERMISSION_GROUPS: Record<Permission, string[]> = {
  ...
  [P.DISPATCH_SMART_ASSIGN_RECOMMEND]: ["dispatch.smart_assign.recommend", "dispatch:view", "dispatch:manage", "dispatch:assign"],
  [P.DISPATCH_SMART_ASSIGN_ACCEPT]: ["dispatch.smart_assign.accept", "dispatch:view", "dispatch:manage", "dispatch:assign"],
  [P.DISPATCH_SMART_ASSIGN_REJECT]: ["dispatch.smart_assign.reject", "dispatch:view", "dispatch:manage", "dispatch:assign"],
  [P.OPERATIONS_SITE_ACCESS_READ]: ["operations.site_access.read", "dispatch:view", "dispatch:manage", "job.update"],
  [P.OPERATIONS_SITE_ACCESS_CREATE]: ["operations.site_access.create", "dispatch:view", "dispatch:manage", "job.update"],
  [P.OPERATIONS_SITE_ACCESS_UPDATE]: ["operations.site_access.update", "dispatch:view", "dispatch:manage", "job.update"],
  [P.OPERATIONS_ACCESS_DOCUMENT_READ]: ["operations.access_document.read", "dispatch:view", "dispatch:manage", "driver:self"],
  [P.OPERATIONS_ACCESS_DOCUMENT_CREATE]: ["operations.access_document.create", "dispatch:view", "dispatch:manage", "driver:self"],
  [P.OPERATIONS_ACCESS_DOCUMENT_UPDATE]: ["operations.access_document.update", "dispatch:view", "dispatch:manage", "driver:self"],
  [P.OPERATIONS_ACCESS_DOCUMENT_VERIFY]: ["operations.access_document.verify", "dispatch:view", "dispatch:manage", "driver:self"],
  [P.OPERATIONS_PICKUP_AUTHORIZATION_READ]: ["operations.pickup_authorization.read", "dispatch:view", "dispatch:manage", "driver:self"],
  [P.OPERATIONS_PICKUP_AUTHORIZATION_CREATE]: ["operations.pickup_authorization.create", "dispatch:view", "dispatch:manage", "driver:self"],
  [P.OPERATIONS_PICKUP_AUTHORIZATION_UPDATE]: ["operations.pickup_authorization.update", "dispatch:view", "dispatch:manage", "driver:self"],
  [P.OPERATIONS_PICKUP_AUTHORIZATION_VERIFY]: ["operations.pickup_authorization.verify", "dispatch:view", "dispatch:manage", "driver:self"],
  [P.OPERATIONS_WAREHOUSE_HANDOVER_READ]: ["operations.warehouse_handover.read", "dispatch:view", "dispatch:manage", "driver:self"],
  [P.OPERATIONS_WAREHOUSE_HANDOVER_CREATE]: ["operations.warehouse_handover.create", "dispatch:view", "dispatch:manage", "driver:self"],
  [P.OPERATIONS_WAREHOUSE_HANDOVER_UPDATE]: ["operations.warehouse_handover.update", "dispatch:view", "dispatch:manage", "driver:self"],
  [P.OPERATIONS_PROOF_READ]: ["operations.proof.read", "dispatch:view", "dispatch:manage", "driver:self", "customer_portal:view"],
  [P.OPERATIONS_PROOF_CREATE]: ["operations.proof.create", "dispatch:view", "dispatch:manage", "driver:self", "customer_portal:view"],
  [P.OPERATIONS_PROOF_UPDATE]: ["operations.proof.update", "dispatch:view", "dispatch:manage", "driver:self", "customer_portal:view"],
  [P.OPERATIONS_PROOF_SUBMIT]: ["operations.proof.submit", "dispatch:view", "dispatch:manage", "driver:self", "customer_portal:view"],
  [P.OPERATIONS_PROOF_VALIDATE]: ["operations.proof.validate", "dispatch:view", "dispatch:manage", "driver:self", "customer_portal:view"],
  [P.OPERATIONS_PROOF_ARTIFACT_READ]: ["operations.proof_artifact.read", "operations.proof.read", "dispatch:view", "dispatch:manage", "driver:self", "customer_portal:view"],
  [P.OPERATIONS_PROOF_ARTIFACT_CREATE]: ["operations.proof_artifact.create", "operations.proof.read", "dispatch:view", "dispatch:manage", "driver:self", "customer_portal:view"],
