  ...
  return (
    <div className="fleet-console space-y-3">
      ...
      <div className="grid grid-cols-2 gap-3 xl:grid-cols-4">
        <ClayStat Icon={Route}         tone="fc-clay-teal"    iconCls="text-teal-700"    label="Trips" value={trips.length} caption="Current count" />
        <ClayStat Icon={Clock}         tone="fc-clay-sky"     iconCls="text-sky-700"     label="Planned" value={planned} caption="Awaiting dispatch start" />
        <ClayStat Icon={Truck}         tone="fc-clay-emerald" iconCls="text-emerald-700" label="Active" value={active} caption="In motion" />
        <ClayStat Icon={AlertTriangle} tone="fc-clay-red"     iconCls="text-rose-700"    label="Exceptions" value={exceptionCount} caption={exceptionCount > 0 ? "Needs review" : "Clear"} alert={exceptionCount > 0} />
      </div>
