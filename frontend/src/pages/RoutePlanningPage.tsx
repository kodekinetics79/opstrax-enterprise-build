          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-3 mb-3">
              <span className="inline-flex items-center gap-1.5 rounded-lg bg-white/90 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.2em] text-teal-700 ring-1 ring-teal-200/50 shadow-sm">
                <MapPin className="h-3 w-3" /> Route Planning
              </span>
              <span className="text-[11px] font-semibold text-slate-500">Route intelligence and stop orchestration</span>
            </div>
            ...
            <p className="mt-1 text-[13px] font-medium text-slate-400 tracking-wide">
              Plan routes, manage stops, preview optimization, inspect SLA risk by stop and export route plans without paid map APIs.
            </p>
          </div>
          <div className="flex items-center gap-2">
            <button className="fh-btn-primary" onClick={() => setEditing({ status: "Planned", routeType: "Delivery", optimizationMode: "Balanced" })}><Plus className="h-4 w-4" /> Create Route</button>
            <button className="fh-btn-ghost" onClick={() => exportRoutes(rows)}><Download className="h-4 w-4" /> Export Route Plan</button>
          </div>
        </div>
      </div>
    </header>
