    ...
    <div className="flex items-center gap-2.5">
      ...
      {!collapsed && (
        <div className="min-w-0">
          <p className="truncate text-sm font-black tracking-[0.16em] text-slate-950 dark:text-white">ZAYRA</p>
          <p className="truncate text-[10px] font-medium text-slate-400 dark:text-slate-500">Workforce Intelligence</p>
        </div>
      )}
    </div>
  );
