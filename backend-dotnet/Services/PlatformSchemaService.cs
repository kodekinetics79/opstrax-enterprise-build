...
public sealed class PlatformSchemaService(Database db)
{
    ...
    private static readonly Dictionary<string, (string Name, string Description, string[] Permissions)> RoleSeed = new()
    {
        ...
        ["product_admin"] = ("Product Admin", "Manage feature entitlements, packages and platform health.",
            ["platform:dashboard:view", "platform:tenants:view", "platform:entitlements:view", "platform:entitlements:manage", "platform:pilot:run", "platform:packages:view", "platform:packages:manage", "platform:countries:view", "platform:countries:manage", "platform:devices:view", "platform:devices:manage", "platform:ops:view"]),
