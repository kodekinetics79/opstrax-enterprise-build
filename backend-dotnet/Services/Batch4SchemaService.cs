...
public sealed class Batch4SchemaService(Database db)
{
    ...
    [
        "CREATE INDEX IF NOT EXISTS ix_b4_safety_events ON safety_events(company_id, severity, review_status, occurred_at)",
