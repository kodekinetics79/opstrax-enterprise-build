...
public sealed class Batch4SchemaService(Database db, IConfiguration? configuration = null)
{
    ...
    [
        ...
        new("safety_events", "device_id",                 "BIGINT NULL"),
        new("safety_events", "source_telemetry_alert_id", "BIGINT NULL"),
        new("safety_events", "source_location_event_id",  "BIGINT NULL"),
        new("safety_events", "score_impact",               "DECIMAL(5,2) NULL"),
        new("safety_events", "evidence_hash",              "VARCHAR(64) NULL"),
        new("safety_events", "meta_json",                  "JSONB NULL"),
        new("safety_events", "reviewed_at",               "TIMESTAMPTZ NULL"),
        new("safety_events", "resolved_at",               "TIMESTAMPTZ NULL"),
        new("safety_events", "reviewed_by",               "BIGINT NULL"),
        new("safety_events", "notes",                     "TEXT NULL"),
