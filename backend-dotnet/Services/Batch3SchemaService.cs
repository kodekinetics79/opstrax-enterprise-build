...
public sealed class Batch3SchemaService(Database db, IConfiguration? configuration = null)
{
    ...
    [
        ...
        new("documents", "risk_score", "DECIMAL(6,2) NULL DEFAULT 20"),
        new("documents", "lifecycle_mode", "VARCHAR(20) NOT NULL DEFAULT 'legacy_unknown' CHECK (lifecycle_mode IN ('automatic','manual','legacy_unknown'))"),
        new("documents", "lifecycle_assessed_on", "DATE NULL"),
