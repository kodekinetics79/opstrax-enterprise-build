        ...
        await db.ExecuteAsync(
            @"INSERT INTO company_security_settings
              ...
              ON CONFLICT (company_id) DO UPDATE SET
                ...
                password_requires_uppercase    = EXCLUDED.password_requires_uppercase,
                password_requires_number       = EXCLUDED.password_requires_number,
                password_requires_symbol       = EXCLUDED.password_requires_symbol,
                ...
                allowed_sso_providers          = EXCLUDED.allowed_sso_providers,
                export_approval_required       = EXCLUDED.export_approval_required,
