...
public sealed class KsaDescriptor : ICountryPackDescriptor
{
    public PackDescriptor GetDescriptor() => new(
        ...
        SocialInsuranceDescription:
            "General Organization for Social Insurance — Saudi nationals: Annuities (9% EE + 9% ER) + SANED (0.75% each) on covered wage (basic+housing, ≤ SAR 45,000). Expatriates: Occupational Hazard only (2% employer).",
        EosbFormula:
