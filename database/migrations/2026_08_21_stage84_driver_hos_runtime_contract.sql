...
GRANT SELECT,INSERT,UPDATE,DELETE ON TABLE public.driver_offline_queue TO opstrax_app,opstrax_system;
...
GRANT SELECT,INSERT,UPDATE,DELETE ON TABLE public.hos_records TO opstrax_app,opstrax_system;

GRANT USAGE,SELECT ON SEQUENCE public.driver_offline_queue_id_seq TO opstrax_app,opstrax_system;
GRANT USAGE,SELECT ON SEQUENCE public.hos_records_id_seq TO opstrax_app,opstrax_system;
