...
| Fleet core | `fleet-utilization`, `fleet-workspace`, `fleet-cold-chain`, `fleet-assets`, `branches`, `vehicles`, `drivers`, `owners`, `assignments`, `documents` | tenant fleet/dispatch/compliance RBAC and operating-market policy |
